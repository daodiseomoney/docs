# ODISEO Docs Style guide

Use the following style guide to ensure the ODISEO documentation is understandable, useful, consistent, and organized.

Although the current ODISEO documentation doesn't adhere to all of the following style guidelines, apply them when you revise the current content and write new content. Over time, the style guidelines will be applied throughout the documentation.
...
Use natural language, like a person. Always assume ODISEO users are not experts, and simplify the content while maintaining technical accuracy. Avoid technical jargon.

### Be aware of your audience

Always consider ODISEO users' needs and help them complete processes quickly and easily. Do this by including all steps in procedures, suggesting best practices, and including tips and other types of notes.
...
Here are some of the more important guidelines we use. If you follow at least these guidelines, your content will begin to resemble other parts of the documentation, making a consistent experience for ODISEO users.
...
Remember the two primary types of ODISEO users: new and experienced.
