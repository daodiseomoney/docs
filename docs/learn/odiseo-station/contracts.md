...
Smart contracts are an advanced feature of ODISEO Station. If you’re using ODISEO Station for the first time, follow the [ODISEO Station tutorial](download/ODISEO-station-desktop.md).
...
Deploy a contract by uploading your `.wasm` file to ODISEO Station.

1. Open ODISEO Station and connect your wallet. Click **Contracts**.
