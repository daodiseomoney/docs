...
The following code snippet requires LocalODISEO.
...
async function main() {
  ...
  // Granter (ODISEO1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v)
  ...
  // Grantee (ODISEO17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp)
  ...
  await sendAuthorized(
    ...
    grantee,
    // Test3
    "ODISEO1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95",
    "2000000000000ukrw"
  )
    .then((tx) => client.tx.broadcast(tx))
    .then(console.info)
